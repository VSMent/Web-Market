...
//        Boolean isUserComplete = (Boolean) session.getAttribute("isUserCompletes");
    ...
    <form class="siteF userData" method="POST" action="LoginUser">
        ...
        <input class="loginInput" id="userAddress" name="address" maxlength="100" type="text"><br>
        <label for="fullChange">Edit Email and Pass</label>
